...
const saluTextContainer = document.querySelector(".salutextcontainer")
const salutImgContainer = document.querySelector(".salutimgcontainer")
...
const projecTitle = document.querySelector(".projecttitle")
...
window.addEventListener("scroll", ()=>{
    ...
    saluTextContainer.style.transform= `translateY(${offsetY * 0.1}px)`
    salutImgContainer.style.transform= `translate(${offsetY * 0.4}px,${offsetY * 0.7}px)`
    ...
    projecTitle.style.transform = `translateY(calc(400vh - ${offsetY}px))`
    phone.style.transform = `translateX(calc(500vh - ${offsetY}px))`
    laptop.style.transform = `translateX(calc(650vh - ${offsetY}px))`
